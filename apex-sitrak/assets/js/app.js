  ...
  function agencias() {
    ...
    function pintar() {
      ...
      lista.innerHTML = items.map(function (a) {
        return '<div class="agency"><div><b>' + esc(a.ciudad) + "</b><br><span>" + esc(a.estado) + " &middot; Tel. " + esc(a.tel) + "</span></div>" +
          '<div class="row"><a class="btn btn--outline btn--sm" href="#">Cómo llegar</a>' +
          '<a class="btn btn--amber btn--sm" href="cotizar.html">Contactar</a></div></div>';
      }).join("");
    }
