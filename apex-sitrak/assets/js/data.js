/* Generado por _build.mjs — no editar a mano. Fuente: _src/data.mjs */
window.APEX = {
  "PC": "Por confirmar",
  "LINEAS": [
    {
      ...
      "opts": [
        {
          "v": "urbano",
          "b": "Reparto urbano",
          "s": "Paquetería, abarrote, última milla"
        },
        {
          "v": "general",
          "b": "Carga general",
          "s": "Caja seca, refrigerada o plataforma"
        },
        {
          "v": "granel",
          "b": "Material a granel",
          "s": "Pétreo, terracería, obra"
        },
        {
          "v": "especial",
          "b": "Carga sobredimensionada",
          "s": "Maquinaria, estructuras"
        }
      ]
    },
    {
      ...
      "opts": [
        ...
        },
        {
          "v": "mixto",
          "b": "Mixto",
          "s": "Ciudad y carretera"
        }
      ]
    },
    {
      "k": "peso",
      "q": "¿Cuánto peso mueves por viaje?",
      "opts": [
        {
          "v": "8",
          "b": "Hasta 8 toneladas",
  ...
  "SEMINUEVOS": [
    {
      ...
      "condicion": "Excelente",
      "img": "assets/img/tracto-wide.jpg",
      "nota": "Un solo operador, mantenimiento en agencia, con historial de servicio completo."
    },
    {
      "id": "sn-002",
      "nombre": "Sitrak Tracto 540HP 6×4 AMT",
      ...
      "condicion": "Muy bueno",
      "img": "assets/img/tracto-wide.jpg",
      "nota": "Transmisión automatizada, llantas al 70 %."
    },
    {
      "id": "sn-003",
      "nombre": "Sitrak Tracto Diesel 540HP 6×4",
      ...
      "condicion": "Muy bueno",
      "img": "assets/img/tracto-hero.jpg",
      "nota": "Ruta federal, retardador ZF en buen estado."
    },
    {
      "id": "sn-004",
      "nombre": "Sitrak Volteo 6×4",
      ...
      "condicion": "Bueno",
      "img": "assets/img/tracto-frente.jpg",
      "nota": "Caja de 16 m³, uso en obra, chasis sin golpes."
    },
    {
      "id": "sn-005",
      "nombre": "Sitrak Chasis 360HP 6×4",
      ...
      "condicion": "Excelente",
      "img": "assets/img/tracto-frente.jpg",
      "nota": "Con caja seca de 8.5 m incluida."
    },
    {
      "id": "sn-006",
      "nombre": "Sitrak 62K 330HP 6×4",
      ...
      "condicion": "Bueno",
      "img": "assets/img/tracto-frente.jpg",
      "nota": "Reparto regional, motor con servicio mayor reciente."
    },
    {
      "id": "sn-007",
      "nombre": "Sitrak 6T",
      ...
      "condicion": "Excelente",
      "img": "assets/img/tracto-wide.jpg",
      "nota": "Última milla, caja seca original de fábrica."
    },
    {
      "id": "sn-008",
      "nombre": "Sitrak 8×4 Minero",
      ...
      "condicion": "Muy bueno",
      "img": "assets/img/tracto-frente.jpg",
      "nota": "Uso minero, suspensión reforzada revisada."
    }
  ],
  "REFACCIONES": [
    {
      "np": "[MT13-0101]",
      "nombre": "Kit de empaques de culata MT13",
      "sistema": "motor",
      "precio": 8450,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
        "sitrak-tracto-540hp-6x4-amt",
        "sitrak-g7-540hp-6x4"
      ]
    },
    {
      "np": "[MT13-0204]",
      "nombre": "Bomba de agua MT13",
      "sistema": "motor",
      "precio": 6200,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
    ...
    {
      "np": "[MC11-0310]",
      "nombre": "Turbocargador MC11",
      "sistema": "motor",
      "precio": 24800,
      "compat": [
        "sitrak-chasis-360hp-6x4"
      ]
    },
    {
      "np": "[FRN-1020]",
      "nombre": "Juego de balatas eje delantero",
      "sistema": "frenos",
      "precio": 3980,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
        "sitrak-tracto-540hp-6x4-amt",
        "sitrak-62k-330hp-6x4"
      ]
    },
    {
      "np": "[FRN-1044]",
      "nombre": "Disco de freno eje trasero MCP16",
      "sistema": "frenos",
      "precio": 7350,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4"
    ...
    {
      "np": "[FRN-1180]",
      "nombre": "Secador de aire con cartucho",
      "sistema": "frenos",
      "precio": 5120,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
    ...
    {
      "np": "[ZF16-2201]",
      "nombre": "Kit de embrague ZF 16 velocidades",
      "sistema": "transmision",
      "precio": 18600,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
    ...
    {
      "np": "[AMT-2310]",
      "nombre": "Actuador de cambios AMT 12 vel.",
      "sistema": "transmision",
      "precio": 21400,
      "compat": [
        "sitrak-tracto-540hp-6x4-amt"
    ...
    {
      "np": "[SUS-3105]",
      "nombre": "Bolsa de aire suspensión de cabina",
      "sistema": "suspension",
      "precio": 4300,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
    ...
    {
      "np": "[SUS-3208]",
      "nombre": "Muelle reforzado eje trasero",
      "sistema": "suspension",
      "precio": 9700,
      "compat": [
        "sitrak-volteo-6x4",
    ...
    {
      "np": "[FIL-4012]",
      "nombre": "Filtro de combustible con separador",
      "sistema": "filtracion",
      "precio": 890,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
    ...
    {
      "np": "[ELE-5301]",
      "nombre": "Faro principal LED lado izquierdo",
      "sistema": "electrico",
      "precio": 6800,
      "compat": [
        "sitrak-tracto-diesel-540hp-6x4",
